...
public interface ApplicationsApiService {
      public Response getAPIS(String applicationUUID, String name, String owner, String tenantDomain, MessageContext messageContext) throws APIManagementException;
}
